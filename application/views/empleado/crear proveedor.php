<div class="well span9 offset1">
    ...
    <?php if(isset($actualizar)): ?>
        <?= form_open("$user/proveedor/editar/".urlencode($cif), array('class'=>'form-horizontal','id'=>'empresaForm')); ?>
        <legend> Actualizar proveedor </legend>
    <?php else: ?>
        <?= form_open("$user/proveedor/crear",array('class'=>'form-horizontal', 'id'=>'empresaForm')); ?>                           
    ...
    <div>
        <?php if(isset($actualizar)): ?>
            <?= form_submit($boton, 'Actualizar proveedor'); ?>
        <?php else: ?>
            <?= form_submit($boton, 'Crear proveedor'); ?>
        <?php endif;?>
    </div>    
    <?= form_close(); ?>
</div>
